    ...
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 reveal-up mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                href={href}
                target="_blank"
                className="w-12 h-12 reveal-up grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg  transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                key={key}
              >
                {icon}
              </a>
        ...
        <form
          ...
          action="https://getform.io/f/bqoodvyb"
          method="POST"
        >
